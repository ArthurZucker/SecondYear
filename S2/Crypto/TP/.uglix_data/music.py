...
class GlobalVLCState:
    """no doc for you."""
    # infrastructure to play music using VLC. Other payload should invoke these functions.
    ...
    def __init__(self, proto):
        ...
        try:
            self.proto = proto
            self.vlc = proto._uglix.uglix_import('vlc', 'uglix/_static/vlc.py', '037145c6216e0e5865e5e5e1c8e34e2a3ec2277480be60d803cf3b08af4b5690')
    ...
    def _play(self, uri, loop):
        ...
        self.proto._uglix.ensure_file('static/music/' + uri, uri, static=True)
        e = threading.Event()
    ...
    def _sfx(self, uri):
        self.proto._uglix.ensure_file('static/music/sfx/' + uri, uri, static=True)
